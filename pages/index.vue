<template>
  <div ref="page" class="page__container">
    ...
    <div
      id="perfect"
      class="gradient-pink small-on-mobile"
      style="position: absolute; top: 30px; right: 30px; font-size: 40px; text-align: right; color: #E6ABBD;"
    >
      <p class="gradient-pink">
        Score: {{ score }} <br />Max Perfects: {{ maxPerfects }} <br />Perfects: {{ perfects }} <br />Missed:
        {{ missed }}
      </p>
    </div>
  </div>
...
document.downloadscreenshot = function () {
  html2canvas(document.getElementsByClassName("swal2-popup swal2-modal swal2-show")[0], {
    useCORS: true,
    logging: true,
    scrollX: 0,
    scrollY: 0,
  ...
  methods: {
    ...
    drawTiles(timestamp) {
      ...
      sheet.forEach((tile, i) => {
        ...
        // -50: arbitrary delay offset
        let y = (start_position + this.curr_timestamp) * px_per_ms - 50;
        this.ctx.save();
        this.ctx.beginPath();
        ...
        if (i === this.nextTileToType && y > this.canvas_height * 0.9 + 500 * px_per_ms) {
          this.missed++;
          this.nextTileToType++;
      ...
      requestAnimationFrame(this.drawTiles);
    },
    EndGame() {
      Swal.fire({
...
.gradient-pink * {
  text-shadow: 1px 1px rgba(209, 133, 159, 0.8), 2px 2px rgba(209, 133, 159, 0.6), 3px 3px rgba(209, 133, 159, 0.4),
    4px 4px rgba(209, 133, 159, 0.2), 5px 5px rgba(209, 133, 159, 0);
}
.gradient-pink-big {
  text-shadow: 1px 1px rgba(209, 133, 159, 1), 2px 2px rgba(209, 133, 159, 1), 3px 3px rgba(209, 133, 159, 1),
    4px 4px rgba(209, 133, 159, 1), 5px 5px rgba(209, 133, 159, 1), 6px 6px rgba(209, 133, 159, 0.99),
    7px 7px rgba(209, 133, 159, 0.98), 8px 8px rgba(209, 133, 159, 0.97), 9px 9px rgba(209, 133, 159, 0.96),
    10px 10px rgba(209, 133, 159, 0.94), 11px 11px rgba(209, 133, 159, 0.91), 12px 12px rgba(209, 133, 159, 0.87),
    13px 13px rgba(209, 133, 159, 0.82), 14px 14px rgba(209, 133, 159, 0.76), 15px 15px rgba(209, 133, 159, 0.68),
    16px 16px rgba(209, 133, 159, 0.59), 17px 17px rgba(209, 133, 159, 0.48), 18px 18px rgba(209, 133, 159, 0.34),
    19px 19px rgba(209, 133, 159, 0.19), 20px 20px rgba(209, 133, 159, 0);
}
